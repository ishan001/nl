    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Edit Coaching</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box red">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-reorder"></i>Coaching Coaching
                        </div>
                    </div>
                        ...
                        <form action="#" id="coaching_form" class="form-horizontal" method="post">
                            <div class="form-body">
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="staff_id">
                                            ...
                                            <?php foreach ($staff as $row2) { ?>  
                                                <option value="<?= $row2->id ?>" <?php if ($row->staff_id == $row2->id) echo "selected"; ?>  ><?= $row2->fname . " " . $row2->lname ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group input-medium date date-picker"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                            <input type="text" class="form-control" readonly name="coaching_date" value="<?= $row->coaching_date ?>" >
                                ...
                                <div class="form-group last">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="ckeditor form-control" name="details" rows="6" data-error-container="#editor2_error"><?= $row->details ?></textarea>
    ...
    jQuery(document).ready(function () {
        ...
        coaching_form.validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>coach/update",
                    data: dataString,
