                            ...
                            <table class="table table-striped table-bordered table-hover" id="all_staff_tbl">
                                <thead>
                                    ...
                                    <tr <?php if($row->active=="0") echo 'class="danger"'; ?> >
                                        <td><?=$i?></td>
                                        <td><a href="<?php echo base_url(); ?>staff/profile/<?=$row->id?>"><?=$row->fname." ".$row->lname;?></a></td>
                                        <td><?=$row->sales_id?></td>
                                        <td><?=$row->staff_type?></td>
                                        <td style="text-align: center">
                                           <a class="btn default btn-xs green-stripe" href="<?php echo base_url(); ?>staff/edit/<?=$row->id?>"> Edit </a> 
                                           <a class="btn default btn-xs inactiveBtn  <?php if($row->active=="1") echo 'red-stripe'; else echo 'green-stripe' ?>" activeType="<?php if($row->active=="1") echo 'Inactive'; else echo 'Active' ?>" idval="<?=$row->id?>"> <?php if($row->active=="1") echo 'Inactive'; else echo 'Active' ?> </a> 
                                        </td>
                                        <td style="text-align: center">
                                           <a class="btn default btn-xs blue-stripe" href="<?php echo base_url(); ?>coach/log_user_view/<?=$row->id?>"> View </a> 
                                        </td>
                                        <td style="text-align: center">
                                           <a class="btn default btn-xs blue-stripe" href="<?php echo base_url(); ?>coach/cal_user_view/<?=$row->id?>"> View </a> 
                                        </td>
                                    </tr>
                                    <?php $i++; } ?>
                                </tbody>
