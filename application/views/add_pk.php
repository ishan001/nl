    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Add New PK</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box red">
                    <div class="portlet-title">
                        <div class="caption">
                                <i class="fa fa-reorder"></i>Add New PK
                        </div>
                    </div>
                        ...
                        <form action="#" id="pk_porm" class="form-horizontal" method="post">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input name="pk_title" type="text" class="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="checkbox-list">
                                                <?php  foreach($staff as $row) { ?>                                                       
                                                    <label><input type="checkbox" value="<?=$row->id?>" name="staff_id[]">  <?=$row->fname." ".$row->lname?> </label>                  
                                                <?php } ?>
                                        </div>
                                    </div>
                                </div>
    ...
    pk_porm.validate({
        ...
        submitHandler: function (form) {
            ...
            dataString = $("#pk_porm").serialize(); 
             $.ajax({
               type: "POST",
               url: "<?php echo base_url(); ?>pk/create",
               data: dataString,
