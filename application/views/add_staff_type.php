    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="page-title">Add New Staff Type</h3>
            ...
            <div class="col-md-12">
                ...
                <div class="portlet box red">
                    <div class="portlet-title">
                        <div class="caption">
                                <i class="fa fa-reorder"></i>Add New Staff Type
                        </div>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="input-group color colorpicker-default" data-color="#3865a8" data-color-format="rgba">
                                            <input type="text" class="form-control" value="#3865a8" readonly name="color">
    ...
    staff_form.validate({
        ...
        submitHandler: function (form) {
            ...
            dataString = $("#staff_form").serialize(); 
             $.ajax({
               type: "POST",
               url: "<?php echo base_url(); ?>staff_type/create",
               data: dataString,
